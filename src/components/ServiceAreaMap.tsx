...
const cities: CityInfo[] = [
  {
    ...
    lng: -122.2712,
    slug: '/oakland',
    description: 'Same-day delivery to all Oakland neighborhoods. Downtown, Fruitvale, Temescal & more.',
    tag: 'Same-Day',
  },
  {
    name: 'Richmond',
    ...
    lng: -122.3478,
    slug: '/richmond',
    description: 'Our fastest delivery zone. Point Richmond, Hilltop, Marina Bay & West Contra Costa.',
    tag: 'Fastest Zone',
  },
  {
    name: 'Concord',
    ...
    lng: -122.0311,
    slug: '/concord',
    description: 'Serving all of Central Contra Costa. Downtown, Todos Santos, Clayton & Pleasant Hill.',
    tag: '170+ searches/mo',
  },
  {
    name: 'Pinole',
    ...
    lng: -122.2989,
    slug: '/pinole',
    description: 'Our home base! Old Town, Pinole Valley, Tara Hills. Fastest response time guaranteed.',
    tag: 'Home Base',
  },
  {
    name: 'Berkeley',
    ...
    lng: -122.2727,
    slug: '#',
    description: 'Serving UC Berkeley area, North Berkeley, South Berkeley & all neighborhoods.',
    tag: 'Coming Soon',
  },
  {
    name: 'Hayward',
    ...
    lng: -122.0808,
    slug: '#',
    description: 'Covering Hayward, Castro Valley, and southern Alameda County.',
    tag: 'Coming Soon',
  },
  {
    name: 'Fremont',
    ...
    lng: -121.9886,
    slug: '#',
    description: 'Dumpster delivery to Fremont, Newark, Union City & southern East Bay.',
    tag: 'Coming Soon',
  },
  {
    name: 'Walnut Creek',
    ...
    lng: -122.0652,
    slug: '#',
    description: 'Premium service for Walnut Creek, Lafayette, Orinda & Lamorinda area.',
    tag: 'Coming Soon',
  },
];
