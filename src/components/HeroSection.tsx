    ...
    <section id="home" className="hero-bg relative min-h-screen flex flex-col justify-center items-center pt-[15vh] pb-[6vh] text-center">
      ...
      <div className="relative z-[2] px-5 pb-10">
        <div className="mb-6">
          <h3 className="inline-block bg-tp-gold-dark text-white px-6 py-2 text-[13px] md:text-base font-bold rounded-[3px] font-[var(--font-poppins)]">
            #1 Choice for dumpster rentals in the Bay Area
          </h3>
        </div>
        ...
        <h2 className="font-[var(--font-poppins)] text-base sm:text-[1.6rem] lg:text-[2rem] font-semibold text-white italic mb-8">
          For contractors, remodelers &amp; everyday cleanups
        </h2>
      ...
      <div className="relative z-[2] flex flex-col lg:flex-row justify-center gap-5 lg:gap-10 w-[90%] lg:w-[80%] max-w-[1080px] mx-auto px-6 py-6 md:px-8 lg:px-10 lg:py-8 bg-white/15 backdrop-blur-[10px] rounded-[10px] mt-5 -mb-[30px]">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="text-white font-[var(--font-poppins)] text-base font-bold mb-1">Trusted by Local Contractors</h4>
            <p className="text-white/85 text-[13px] leading-relaxed">Dependable service with transparent pricing</p>
          </div>
        </div>
        {/* Feature 2 */}
        <div className="flex items-start gap-4">
        ...
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48" height="48"><circle cx="24" cy="24" r="24" fill="#fbeaea"/><circle cx="24" cy="24" r="11" fill="none" stroke="#E02B20" strokeWidth="2.5"/><path d="M24 15v9.5l6 3.5" fill="none" stroke="#E02B20" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="24" cy="24" r="1.5" fill="#E02B20"/></svg>
          </div>
          <div>
            <h4 className="text-white font-[var(--font-poppins)] text-base font-bold mb-1">Flexible Scheduling</h4>
            <p className="text-white/85 text-[13px] leading-relaxed">We work around your timeline</p>
          </div>
        </div>
      </div>
    </section>
