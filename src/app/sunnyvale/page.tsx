...
export const metadata: Metadata = {
  ...
  description:
    "Fast, reliable dumpster rentals in Sunnyvale, CA. Serving Downtown, Lakewood, Cherry Chase, Birdland & all ZIP codes. Same-day delivery. Bilingual support (EN/ES). Call (510) 650-0080",
  keywords: [
