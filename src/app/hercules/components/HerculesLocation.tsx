...
export default function HerculesLocation() {
  const herculesZipCodes = ["94547"];
    ...
    <section id="rent" className="location-bg py-20 pb-15">
      <div className="w-[80%] max-w-[1080px] mx-auto relative">
        ...
        <h2 className="font-[var(--font-poppins)] text-[26px] md:text-[32px] font-bold text-white mb-6 text-center">
          Serving Hercules &amp; West Contra Costa County
        </h2>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          ...
          <div className="border-t border-white/20 pt-6">
            <h3 className="text-white font-[var(--font-poppins)] text-lg font-semibold mb-3 text-center">
              Hercules ZIP Codes We Serve
            </h3>
            <div className="flex flex-wrap justify-center gap-2">
              {herculesZipCodes.map((zip) => (
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          <h3 className="text-white font-[var(--font-poppins)] text-xl font-bold mb-6 text-center">
            Why Hercules Chooses TP Dumpsters
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">Hercules is growing fast with new construction and developments — we have the inventory to keep up.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">West County Coverage</h4>
                <p className="text-white/80 text-sm">One call covers Hercules, Pinole, Rodeo, Crockett, Martinez, and all of West Contra Costa.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
        ...
        <h2 className="font-[var(--font-poppins)] text-[22px] md:text-[28px] font-bold text-white mb-6 text-center">
          Ready to rent your dumpster in Hercules?
        </h2>
        <a
