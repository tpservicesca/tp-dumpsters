...
const otherPages = ["booking", "contractors", "general-debris", "construction-debris", "roofing", "household-cleanout", "green-waste", "clean-soil", "clean-concrete", "mixed-materials"];
