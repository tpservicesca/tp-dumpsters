...
const cities = ["oakland", "pinole", "richmond", "concord", "berkeley", "hayward", "fremont", "walnut-creek", "alameda", "antioch", "san-leandro", "vallejo", "livermore", "lafayette", "pleasanton", "san-ramon", "dublin", "brentwood", "union-city", "newark", "pleasant-hill", "martinez", "pittsburg", "castro-valley", "hercules", "el-cerrito", "danville", "benicia", "oakley", "san-pablo", "orinda", "moraga", "bay-point", "american-canyon", "el-sobrante", "san-francisco", "san-jose", "san-rafael", "novato", "mill-valley", "sausalito", "tiburon", "clayton", "rodeo", "crockett", "discovery-bay", "bethel-island", "contra-costa-county", "fairfield"];
