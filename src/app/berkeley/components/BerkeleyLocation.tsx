...
export default function BerkeleyLocation() {
  const berkeleyZipCodes = ["94701", "94702", "94703", "94704", "94705", "94706", "94707", "94708", "94709", "94710", "94720"];
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="text-white font-semibold mb-1">Tight-Street Specialists</h4>
                <p className="text-white/80 text-sm">Berkeley&apos;s narrow streets and historic neighborhoods are no problem — we navigate them daily.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Eco-Conscious Disposal</h4>
                <p className="text-white/80 text-sm">We recycle and divert as much waste as possible, matching Berkeley&apos;s green values.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
