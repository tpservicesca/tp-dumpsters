...
export default function MillValleyLocation() {
  const millValleyZipCodes = [
    "94941", "94942"
  ];
    ...
    <section id="rent" className="location-bg py-20 pb-15">
      <div className="w-[80%] max-w-[1080px] mx-auto relative">
        ...
        <h2 className="font-[var(--font-poppins)] text-[26px] md:text-[32px] font-bold text-white mb-6 text-center">
          Serving All Mill Valley Neighborhoods
        </h2>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          ...
          <div className="border-t border-white/20 pt-6">
            <h3 className="text-white font-[var(--font-poppins)] text-lg font-semibold mb-3 text-center">
              Mill Valley ZIP Codes We Serve
            </h3>
            <div className="flex flex-wrap justify-center gap-2">
              {millValleyZipCodes.map((zip) => (
                <span
                  key={zip}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">Our drivers navigate Mill Valley&apos;s narrow, winding roads and steep driveways daily.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Eco-Conscious Service</h4>
                <p className="text-white/80 text-sm">Responsible disposal practices that align with Mill Valley&apos;s environmental values.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
        ...
        <h2 className="font-[var(--font-poppins)] text-[22px] md:text-[28px] font-bold text-white mb-6 text-center">
          Ready to rent your dumpster in Mill Valley?
        </h2>
        <a
