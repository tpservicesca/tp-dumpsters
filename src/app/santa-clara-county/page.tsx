...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Santa Clara County waste removal",
    "construction dumpster Silicon Valley",
    "cheap dumpster rental Santa Clara County",
    "same day dumpster delivery Santa Clara County",
    "TP Dumpsters",
  ],
  openGraph: {
    title: "Dumpster Rental in Santa Clara County, CA | TP Dumpsters",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "TP Dumpsters serving Santa Clara County",
      },
    ],
  },
  alternates: {
    canonical: "https://tpdumpsters.com/santa-clara-county",
  },
  robots: {
    index: true,
    follow: true,
...
const countyFaqs = [
  {
    ...
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        We serve all major cities across <strong>Santa Clara County</strong> including San Jose, Sunnyvale, Santa Clara, Mountain View, Milpitas, and Palo Alto. Whether you&apos;re in the heart of Silicon Valley or a quieter residential neighborhood, we deliver.
      </p>
    ),
  },
  {
  ...
  {
    question: "Do you offer same-day delivery in Santa Clara County?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        Yes! We offer <strong>same-day delivery</strong> to most Santa Clara County cities when you call before noon. Our service network allows us to reach cities from San Jose to Palo Alto quickly and efficiently.
      </p>
    ),
  },
  {
  ...
  {
    question: "Do I need a permit for a dumpster in Santa Clara County?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        If the dumpster is placed on your <strong>private property</strong> (driveway, yard), no permit is needed. For street placement, permit requirements vary by city — San Jose, Sunnyvale, Palo Alto, and other cities each have their own rules. We&apos;ll guide you through the process for your specific city.
      </p>
    ),
  },
  {
  ...
  {
    question: "What areas outside Santa Clara County do you serve?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        In addition to all of Santa Clara County, we also serve <strong>Alameda County</strong> (Oakland, Berkeley, Fremont, Hayward), <strong>Contra Costa County</strong> (Concord, Walnut Creek, Richmond), <strong>San Mateo County</strong>, <strong>San Francisco</strong>, and <strong>Marin County</strong>. We cover the entire Bay Area!
      </p>
    ),
  },
];
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  name: "TP Dumpsters - Santa Clara County",
  description:
...
export default function SantaClaraCountyPage() {
  return (
    <>
      ...
      <section className="hero-bg relative min-h-screen flex flex-col justify-center items-center pt-[15vh] pb-[6vh] text-center">
        ...
        <div className="relative z-[2] px-5 pb-10">
          ...
          <h1 className="font-[var(--font-oswald)] text-[26px] sm:text-[3rem] lg:text-[4.5rem] font-extrabold text-white uppercase leading-[1.1] mb-4 tracking-wide">
            SANTA CLARA COUNTY<br />DUMPSTER RENTAL
          </h1>
          ...
          <p className="font-[var(--font-poppins)] text-sm sm:text-lg text-white/90 mb-8 max-w-3xl mx-auto">
            San Jose • Sunnyvale • Santa Clara • Mountain View • Milpitas • Palo Alto & More
          </p>
      ...
      <ErrorBoundary>
        <CityFaqsSection cityName="Santa Clara County" faqs={countyFaqs} />
      </ErrorBoundary>
      ...
      <section className="py-16 bg-[#0d1117]">
        <div className="w-[90%] max-w-[1100px] mx-auto">
          ...
          <h2 className="font-[var(--font-poppins)] text-[26px] md:text-[32px] font-bold text-white text-center mb-3">
            Interactive Map — Santa Clara County
          </h2>
          <p className="font-[var(--font-poppins)] text-white/70 text-center mb-10 max-w-2xl mx-auto">
            Click any marker to learn more about dumpster rental in that city. We deliver to every corner of Santa Clara County.
          </p>
          <CountyMapWrapper />
        </div>
      </section>
        ...
        <div className="w-[90%] max-w-[1000px] mx-auto">
          <div className="bg-[#f8f8f8] rounded-2xl p-8 md:p-12 border border-gray-100">
            ...
            <h2 className="font-[var(--font-poppins)] text-[24px] md:text-[30px] font-bold text-[#1a1a1a] mb-8 text-center">
              Your Trusted Dumpster Rental Partner in Santa Clara County
            </h2>
            <div className="space-y-5 text-[#555] text-[15px] leading-[1.85] font-[var(--font-poppins)]">
              <p>
                Santa Clara County is the heart of Silicon Valley, home to some of the world&apos;s most innovative companies and prestigious universities. From the bustling streets of San Jose — the county&apos;s largest city and the capital of Silicon Valley — to the tree-lined neighborhoods of Palo Alto near Stanford University, the county is a dynamic mix of tech campuses, residential communities, and growing developments that constantly generate waste removal needs.
              </p>
              <p>
                TP Dumpsters is proud to serve every major city in Santa Clara County with affordable roll-off dumpster rentals. Whether you&apos;re a homeowner in Sunnyvale remodeling a kitchen, a contractor managing a tech campus build-out in Mountain View, or a property manager clearing out units in Milpitas, we have the right size dumpster for your project. Our fleet includes 10-yard, 20-yard, and 30-yard containers — designed to handle everything from small garage cleanouts to large-scale construction debris.
              </p>
              <p>
                Our service network allows us to reach communities across Santa Clara County quickly. Our same-day delivery service ensures your project stays on schedule, and our transparent pricing means no surprise fees. From San Jose&apos;s sprawling neighborhoods to Santa Clara&apos;s tech corridor near Levi&apos;s Stadium, from Mountain View&apos;s Googleplex area to Palo Alto&apos;s historic Professorville — one call to TP Dumpsters covers it all.
              </p>
              <p>
                We understand that navigating dumpster permits can be confusing, especially when each city in Santa Clara County has its own regulations. That&apos;s why our bilingual team (English and Spanish) is ready to help guide you through the process, answer your questions, and ensure your rental experience is smooth from start to finish. Whether you&apos;re cleaning up after a renovation, demolishing a structure, or tackling a full home remodel, TP Dumpsters delivers reliability, affordability, and outstanding customer service throughout Santa Clara County.
              </p>
            </div>
