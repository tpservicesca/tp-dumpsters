...
export const metadata: Metadata = {
  title: "Dumpster Rental in Alameda County, CA | TP Dumpsters",
  description:
    "Affordable dumpster rental across all Alameda County cities. 10, 20 & 30 yard roll-off containers with same-day delivery. Serving Oakland, Berkeley, Fremont, Hayward, San Leandro & 15+ more cities. Call (510) 650-2083.",
  keywords: [
    "dumpster rental Alameda County",
    "roll-off dumpster Alameda County",
    "Oakland dumpster rental",
    "Berkeley dumpster rental",
    "Fremont dumpster rental",
    "Hayward dumpster rental",
    "San Leandro dumpster rental",
    "Alameda County waste removal",
    "construction dumpster East Bay",
    "cheap dumpster rental Alameda County",
    "same day dumpster delivery Alameda County",
    "TP Dumpsters",
  ],
  openGraph: {
    title: "Dumpster Rental in Alameda County, CA | TP Dumpsters",
    description:
      "Serving 15+ cities across Alameda County. Same-day delivery, transparent pricing, bilingual support. Book online or call (510) 650-2083.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "TP Dumpsters serving Alameda County",
      },
    ],
  },
  alternates: {
    canonical: "https://tpdumpsters.com/alameda-county",
  },
  robots: {
    index: true,
    follow: true,
...
// ── City Data ───────────────────────────────────────────────────────────────
const CITIES = [
  { name: "Oakland", slug: "oakland", tagline: "Largest City" },
  ...
  { name: "San Leandro", slug: "san-leandro", tagline: "East Bay" },
  { name: "Livermore", slug: "livermore", tagline: "Tri-Valley" },
  ...
  { name: "San Lorenzo", slug: "san-lorenzo", tagline: "Eden Area" },
  { name: "Emeryville", slug: "emeryville", tagline: "Innovation Hub" },
  { name: "Piedmont", slug: "piedmont", tagline: "Residential Enclave" },
];

// ── FAQs (using CityFaqsSection format) ─────────────────────────────────────
const countyFaqs = [
  {
    question: "What cities in Alameda County do you serve?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        We serve all <strong>15+ cities and communities</strong> across Alameda County including Oakland, Berkeley, Fremont, Hayward, Alameda, San Leandro, Livermore, Pleasanton, Dublin, Newark, Union City, Castro Valley, San Lorenzo, Emeryville, and Piedmont. If you&apos;re in Alameda County, we deliver.
      </p>
    ),
  },
  {
    question: "How much does a dumpster rental cost in Alameda County?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
  ...
  {
    question: "Do you offer same-day delivery in Alameda County?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        Yes! We offer <strong>same-day delivery</strong> to most Alameda County cities when you call before noon. Our routes cover the entire county from Berkeley and Emeryville in the north to Fremont and Newark in the south, and Livermore and Pleasanton in the east.
      </p>
    ),
  },
  {
    question: "What sizes of dumpsters are available in Alameda County?",
    answer: (
      <>
  ...
  {
    question: "Do I need a permit for a dumpster in Alameda County?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        If the dumpster is placed on your <strong>private property</strong> (driveway, yard), no permit is needed. For street placement, permit requirements vary by city — Oakland, Berkeley, Fremont, and other cities each have their own rules. For unincorporated areas like Castro Valley and San Lorenzo, Alameda County Public Works handles permits. We&apos;ll guide you through the process for your specific location.
      </p>
    ),
  },
  {
  ...
  {
    question: "Can you deliver to Oakland&apos;s hillside neighborhoods or Piedmont&apos;s narrow streets?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        Yes! Our drivers are experienced with the <strong>challenging terrain</strong> found throughout Alameda County — from Oakland&apos;s steep hillside streets in Montclair and Rockridge to Piedmont&apos;s narrow winding roads. We assess access before delivery and use the right equipment for safe placement.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        ¡Sí! We provide full <strong>bilingual support in English and Spanish</strong>. Our team communicates clearly in both languages so every customer across Alameda County feels comfortable throughout the rental process.
      </p>
    ),
  },
  {
    question: "Can I book a dumpster online for Alameda County delivery?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        Absolutely! Book online at <a href="/booking" className="text-tp-red hover:underline font-semibold">tpdumpsters.com/booking</a> and receive an instant <strong>$50 discount</strong>. Select your delivery city anywhere in Alameda County. You can also call us at <a href="tel:+15106502083" className="text-tp-red hover:underline font-semibold">(510) 650-2083</a> for personalized service.
      </p>
    ),
  },
];
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  name: "TP Dumpsters - Alameda County",
  description:
...
export default function AlamedaCountyPage() {
  return (
    <>
      ...
      <section className="hero-bg relative min-h-screen flex flex-col justify-center items-center pt-[15vh] pb-[6vh] text-center">
        ...
        <div className="relative z-[2] px-5 pb-10">
          <div className="mb-6">
            <h3 className="inline-block bg-tp-gold-dark text-white px-6 py-2 text-[13px] md:text-base font-bold rounded-[3px] font-[var(--font-poppins)]">
              Serving 15+ Cities Across Alameda County
            </h3>
          </div>
          <h1 className="font-[var(--font-oswald)] text-[26px] sm:text-[3rem] lg:text-[4.5rem] font-extrabold text-white uppercase leading-[1.1] mb-4 tracking-wide">
            ALAMEDA COUNTY<br />DUMPSTER RENTAL
          </h1>
          ...
          <p className="font-[var(--font-poppins)] text-sm sm:text-lg text-white/90 mb-8 max-w-3xl mx-auto">
            Oakland • Berkeley • Fremont • Hayward • San Leandro • Livermore • Pleasanton • Dublin & More
          </p>
        ...
        <div className="relative z-[2] flex flex-col lg:flex-row justify-center gap-5 lg:gap-10 w-[90%] lg:w-[80%] max-w-[1080px] mx-auto px-6 py-6 md:px-8 lg:px-10 lg:py-8 bg-white/15 backdrop-blur-[10px] rounded-[10px] mt-5 -mb-[30px]">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-white font-[var(--font-poppins)] text-base font-bold mb-1">15+ Cities Served</h4>
              <p className="text-white/85 text-[13px] leading-relaxed">Full Alameda County coverage</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-12 h-12 bg-[#fbeaea] rounded-full flex items-center justify-center">
      ...
      <ErrorBoundary>
        <CityFaqsSection cityName="Alameda County" faqs={countyFaqs} />
      </ErrorBoundary>
      ...
      <section className="py-16 bg-[#0d1117]">
        <div className="w-[90%] max-w-[1100px] mx-auto">
          ...
          <h2 className="font-[var(--font-poppins)] text-[26px] md:text-[32px] font-bold text-white text-center mb-3">
            Interactive Map — Alameda County
          </h2>
          <p className="font-[var(--font-poppins)] text-white/70 text-center mb-10 max-w-2xl mx-auto">
            Click any marker to learn more about dumpster rental in that city. We deliver to every corner of Alameda County.
          </p>
          <CountyMapWrapper />
        </div>
      </section>
        ...
        <div className="w-[90%] max-w-[1000px] mx-auto">
          <div className="bg-[#f8f8f8] rounded-2xl p-8 md:p-12 border border-gray-100">
            ...
            <h2 className="font-[var(--font-poppins)] text-[24px] md:text-[30px] font-bold text-[#1a1a1a] mb-8 text-center">
              Your Trusted Dumpster Rental Partner in Alameda County
            </h2>
            <div className="space-y-5 text-[#555] text-[15px] leading-[1.85] font-[var(--font-poppins)]">
              <p>
                Alameda County is one of the most populous and diverse counties in the San Francisco Bay Area, stretching from the vibrant urban centers of Oakland and Berkeley in the north to the family-oriented communities of Fremont and Newark in the south, and the thriving Tri-Valley cities of Livermore, Pleasanton, and Dublin in the east. With over 1.6 million residents, the county sees constant residential construction, home renovation, and commercial development — all of which generate waste that needs efficient, reliable removal.
              </p>
              <p>
                TP Dumpsters is proud to serve every city and community in Alameda County with affordable roll-off dumpster rentals. Whether you&apos;re a homeowner in Berkeley remodeling a kitchen, a contractor managing a multi-unit development in Oakland, or a property manager clearing out units in Hayward, we have the right size dumpster for your project. Our fleet includes 10-yard, 20-yard, and 30-yard containers — designed to handle everything from small garage cleanouts to large-scale construction debris.
              </p>
              <p>
                Our team knows Alameda County inside and out. We navigate Oakland&apos;s hillside streets, deliver to Emeryville&apos;s compact commercial lots, handle Piedmont&apos;s strict residential requirements, and serve the growing suburban communities of the Tri-Valley. From the island city of Alameda to the unincorporated Eden Area communities of San Lorenzo and Castro Valley, one call to TP Dumpsters covers it all.
              </p>
              <p>
                We understand that navigating dumpster permits can be confusing, especially when each city in Alameda County has its own regulations and unincorporated areas follow county rules. That&apos;s why our bilingual team (English and Spanish) is ready to help guide you through the process, answer your questions, and ensure your rental experience is smooth from start to finish. Whether you&apos;re cleaning up after a storm, demolishing a deck, or tackling a full home renovation, TP Dumpsters delivers reliability, affordability, and outstanding customer service throughout Alameda County.
              </p>
            </div>
