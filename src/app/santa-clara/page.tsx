...
export const metadata: Metadata = {
  ...
  description:
    "Fast, reliable dumpster rentals in Santa Clara, CA. Serving Downtown, Old Quad, Rivermark, Mission District & all ZIP codes. Same-day delivery. Bilingual support (EN/ES). Call (510) 650-0080",
  keywords: [
