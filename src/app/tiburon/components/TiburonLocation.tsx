...
export default function TiburonLocation() {
  const tiburonZipCodes = [
    "94920"
  ];
  ...
  return (
    <section id="rent" className="location-bg py-20 pb-15">
      <div className="w-[80%] max-w-[1080px] mx-auto relative">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          ...
          <div className="border-t border-white/20 pt-6">
            <h3 className="text-white font-[var(--font-poppins)] text-lg font-semibold mb-3 text-center">
              Tiburon ZIP Codes We Serve
            </h3>
            <div className="flex flex-wrap justify-center gap-2">
              {tiburonZipCodes.map((zip) => (
                <span
                  key={zip}
        ...
        {/* Why Choose Us for Tiburon */}
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          <h3 className="text-white font-[var(--font-poppins)] text-xl font-bold mb-6 text-center">
            Why Tiburon Chooses TP Dumpsters
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Peninsula Access</h4>
                <p className="text-white/80 text-sm">We navigate Tiburon&apos;s peninsula roads and steep terrain with precision.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Luxury Property Care</h4>
                <p className="text-white/80 text-sm">Careful dumpster placement that protects driveways and landscaping.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
        ...
        <h2 className="font-[var(--font-poppins)] text-[22px] md:text-[28px] font-bold text-white mb-6 text-center">
          Ready to rent your dumpster in Tiburon?
        </h2>
        <a
