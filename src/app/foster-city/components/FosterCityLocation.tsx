...
export default function FosterCityLocation() {
  const zipCodes = ["94404"];

  return (
    <section id="rent" className="location-bg py-20 pb-15">
      <div className="w-[80%] max-w-[1080px] mx-auto relative">
        <h4 className="font-[var(--font-red-hat)] text-sm font-bold text-tp-gold uppercase tracking-[2px] mb-2 text-center">FOSTER CITY, CALIFORNIA</h4>
        <h2 className="font-[var(--font-poppins)] text-[26px] md:text-[32px] font-bold text-white mb-6 text-center">Serving All Foster City Neighborhoods</h2>
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
            {["Foster City Islands", "Metro Center", "Marlin Cove", "Sea Cloud Park", "Catamaran", "Port Royal", "Flying Mane", "Foster City Lagoon"].map((neighborhood) => (
          ...
          <div className="border-t border-white/20 pt-6">
            <h3 className="text-white font-[var(--font-poppins)] text-lg font-semibold mb-3 text-center">Foster City ZIP Codes We Serve</h3>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          <h3 className="text-white font-[var(--font-poppins)] text-xl font-bold mb-6 text-center">Why Foster City Chooses TP Dumpsters</h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Waterfront Property Care</h4>
                <p className="text-white/80 text-sm">Careful dumpster placement on Foster City&apos;s lagoon-side homes and planned streets.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                ...
                <p className="text-white/80 text-sm">Same-day delivery available across all Foster City neighborhoods.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
        ...
        <h2 className="font-[var(--font-poppins)] text-[22px] md:text-[28px] font-bold text-white mb-6 text-center">Ready to rent your dumpster in Foster City?</h2>
