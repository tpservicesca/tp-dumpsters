...
export default function DixonLocation() {
  const zipCodes = ["95620"];
      ...
      <div className="w-[80%] max-w-[1080px] mx-auto relative">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          <h3 className="text-white font-[var(--font-poppins)] text-xl font-bold mb-6 text-center">
            Why Dixon Chooses TP Dumpsters
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Rural Expertise</h4>
                <p className="text-white/80 text-sm">Experienced with deliveries to farms, ranches, and rural properties.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                ...
                <p className="text-white/80 text-sm">Same-day delivery available throughout Dixon and surrounding areas.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
        ...
        <h2 className="font-[var(--font-poppins)] text-[22px] md:text-[28px] font-bold text-white mb-6 text-center">
          Ready to rent your dumpster in Dixon?
        </h2>
        <a
