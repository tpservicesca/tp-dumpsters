...
export default function SanLorenzoLocation() {
  const sanLorenzoZipCodes = ["94580"];
    ...
    <section id="rent" className="location-bg py-20 pb-15">
      <div className="w-[80%] max-w-[1080px] mx-auto relative">
        ...
        <h2 className="font-[var(--font-poppins)] text-[26px] md:text-[32px] font-bold text-white mb-6 text-center">
          Serving All San Lorenzo Neighborhoods
        </h2>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          ...
          <div className="border-t border-white/20 pt-6">
            <h3 className="text-white font-[var(--font-poppins)] text-lg font-semibold mb-3 text-center">
              San Lorenzo ZIP Codes We Serve
            </h3>
            <div className="flex flex-wrap justify-center gap-2">
              {sanLorenzoZipCodes.map((zip) => (
                <span
                  key={zip}
        ...
        {/* Why Choose Us for San Lorenzo */}
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          <h3 className="text-white font-[var(--font-poppins)] text-xl font-bold mb-6 text-center">
            Why San Lorenzo Chooses TP Dumpsters
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Eden Area Expertise</h4>
                <p className="text-white/80 text-sm">We understand unincorporated Alameda County rules and residential requirements.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                ...
                <p className="text-white/80 text-sm">Same-day delivery available throughout San Lorenzo and nearby communities.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
        ...
        <h2 className="font-[var(--font-poppins)] text-[22px] md:text-[28px] font-bold text-white mb-6 text-center">
          Ready to rent your dumpster in San Lorenzo?
        </h2>
        <a
