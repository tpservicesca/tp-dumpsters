      ...
      <div className="w-[80%] max-w-[1080px] mx-auto relative">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          ...
          <div className="border-t border-white/20 pt-6">
            <h3 className="text-white font-[var(--font-poppins)] text-lg font-semibold mb-3 text-center">
              Dublin ZIP Codes We Serve
            </h3>
            <div className="flex flex-wrap justify-center gap-2">
              {dublinZipCodes.map((zip) => (
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          <h3 className="text-white font-[var(--font-poppins)] text-xl font-bold mb-6 text-center">
            Why Dublin Chooses TP Dumpsters
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">New Construction Experts</h4>
                <p className="text-white/80 text-sm">Dublin&apos;s booming planned communities need big dumpsters — we have the 30-yard inventory to match.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                ...
                <p className="text-white/80 text-sm">One call covers Dublin, Pleasanton, San Ramon, Livermore, and Castro Valley.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
        ...
        <h2 className="font-[var(--font-poppins)] text-[22px] md:text-[28px] font-bold text-white mb-6 text-center">
          Ready to rent your dumpster in Dublin?
        </h2>
        <a
