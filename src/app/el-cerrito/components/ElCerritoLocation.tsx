...
export default function ElCerritoLocation() {
  const elCerritoZipCodes = ["94530"];
    ...
    <section id="rent" className="location-bg py-20 pb-15">
      <div className="w-[80%] max-w-[1080px] mx-auto relative">
        ...
        <h2 className="font-[var(--font-poppins)] text-[26px] md:text-[32px] font-bold text-white mb-6 text-center">
          Serving El Cerrito, Kensington &amp; Albany
        </h2>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          ...
          <div className="border-t border-white/20 pt-6">
            <h3 className="text-white font-[var(--font-poppins)] text-lg font-semibold mb-3 text-center">
              El Cerrito ZIP Codes We Serve
            </h3>
            <div className="flex flex-wrap justify-center gap-2">
              {elCerritoZipCodes.map((zip) => (
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          <h3 className="text-white font-[var(--font-poppins)] text-xl font-bold mb-6 text-center">
            Why El Cerrito Chooses TP Dumpsters
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Older Home Renovation Experts</h4>
                <p className="text-white/80 text-sm">El Cerrito&apos;s mid-century homes need updates — we handle the debris from kitchen remodels to full gut renovations.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Inner East Bay Coverage</h4>
                <p className="text-white/80 text-sm">One call covers El Cerrito, Kensington, Albany, Richmond, Berkeley, and all surrounding communities.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
        ...
        <h2 className="font-[var(--font-poppins)] text-[22px] md:text-[28px] font-bold text-white mb-6 text-center">
          Ready to rent your dumpster in El Cerrito?
        </h2>
        <a
