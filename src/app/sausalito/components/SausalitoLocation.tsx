...
export default function SausalitoLocation() {
  const sausalitoZipCodes = [
    "94965", "94966"
  ];
    ...
    <section id="rent" className="location-bg py-20 pb-15">
      <div className="w-[80%] max-w-[1080px] mx-auto relative">
        ...
        <h2 className="font-[var(--font-poppins)] text-[26px] md:text-[32px] font-bold text-white mb-6 text-center">
          Serving All Sausalito Neighborhoods
        </h2>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          ...
          <div className="border-t border-white/20 pt-6">
            <h3 className="text-white font-[var(--font-poppins)] text-lg font-semibold mb-3 text-center">
              Sausalito ZIP Codes We Serve
            </h3>
            <div className="flex flex-wrap justify-center gap-2">
              {sausalitoZipCodes.map((zip) => (
                <span
                  key={zip}
        ...
        {/* Why Choose Us for Sausalito */}
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
          <h3 className="text-white font-[var(--font-poppins)] text-xl font-bold mb-6 text-center">
            Why Sausalito Chooses TP Dumpsters
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Waterfront Knowledge</h4>
                <p className="text-white/80 text-sm">We understand Sausalito&apos;s waterfront placement restrictions and houseboat area access.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
              <div>
                <h4 className="text-white font-semibold mb-1">Steep Street Navigation</h4>
                <p className="text-white/80 text-sm">Expert delivery on Sausalito&apos;s steep, narrow streets with limited parking.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="text-tp-red text-2xl flex-shrink-0">✓</div>
        ...
        <h2 className="font-[var(--font-poppins)] text-[22px] md:text-[28px] font-bold text-white mb-6 text-center">
          Ready to rent your dumpster in Sausalito?
        </h2>
        <a
