...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Solano County waste removal",
    "construction dumpster Solano County",
    "same day dumpster delivery Solano County",
    "TP Dumpsters",
  ],
  openGraph: {
    title: "Dumpster Rental in Solano County, CA | TP Dumpsters",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "TP Dumpsters serving Solano County",
      },
    ],
  },
  alternates: {
    canonical: "https://tpdumpsters.com/solano-county",
  },
  robots: {
    index: true,
    follow: true,
...
// ── City Data ───────────────────────────────────────────────────────────────
const CITIES = [
  { name: "Vallejo", slug: "vallejo", tagline: "Largest City" },
  { name: "Fairfield", slug: "fairfield", tagline: "County Seat" },
  { name: "Vacaville", slug: "vacaville", tagline: "Gateway City" },
...
const countyFaqs = [
  {
    question: "What cities in Solano County do you serve?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        We serve all <strong>7 cities</strong> across Solano County including Vallejo, Fairfield, Vacaville, Benicia, American Canyon, Suisun City, and Dixon. If you&apos;re in Solano County, we deliver.
      </p>
    ),
  },
  {
    question: "How much does a dumpster rental cost in Solano County?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
  ...
  {
    question: "Do you offer same-day delivery in Solano County?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        Yes! We offer <strong>same-day delivery</strong> to most Solano County cities when you call before noon. From Vallejo to Dixon, our trucks reach every corner of the county quickly and efficiently.
      </p>
    ),
  },
  {
  ...
  {
    question: "Do I need a permit for a dumpster in Solano County?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        If the dumpster is placed on your <strong>private property</strong> (driveway, yard), no permit is needed. For street placement, permit requirements vary by city — Vallejo, Fairfield, and Vacaville each have their own rules. We&apos;ll guide you through the process for your specific city.
      </p>
    ),
  },
  {
  ...
  {
    question: "Do you serve rural areas and farms in Solano County?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        Yes! Solano County has a strong agricultural heritage, especially around <strong>Dixon and rural Vacaville</strong>. We deliver to farms, ranches, and rural properties throughout the county. Our trucks can handle long driveways and unpaved access roads.
      </p>
    ),
  },
  {
  ...
  {
    question: "What other counties do you serve besides Solano County?",
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        In addition to all of Solano County, we also serve <strong>Contra Costa County</strong> (Concord, Walnut Creek, Richmond, Pinole), <strong>Alameda County</strong> (Oakland, Berkeley, Fremont, Hayward), <strong>Marin County</strong> (San Rafael, Novato), <strong>San Francisco</strong>, and <strong>San Jose</strong>. We cover the entire Bay Area!
      </p>
    ),
  },
];
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  name: "TP Dumpsters - Solano County",
  description:
...
export default function SolanoCountyPage() {
  return (
    <>
      ...
      <section className="hero-bg relative min-h-screen flex flex-col justify-center items-center pt-[15vh] pb-[6vh] text-center">
        ...
        <div className="relative z-[2] px-5 pb-10">
          <div className="mb-6">
            <h3 className="inline-block bg-tp-gold-dark text-white px-6 py-2 text-[13px] md:text-base font-bold rounded-[3px] font-[var(--font-poppins)]">
              Serving 7 Cities Across Solano County
            </h3>
          </div>
          <h1 className="font-[var(--font-oswald)] text-[26px] sm:text-[3rem] lg:text-[4.5rem] font-extrabold text-white uppercase leading-[1.1] mb-4 tracking-wide">
            SOLANO COUNTY<br />DUMPSTER RENTAL
          </h1>
          ...
          <p className="font-[var(--font-poppins)] text-sm sm:text-lg text-white/90 mb-8 max-w-3xl mx-auto">
            Vallejo • Fairfield • Vacaville • Benicia • American Canyon • Suisun City • Dixon
          </p>
        ...
        <div className="relative z-[2] flex flex-col lg:flex-row justify-center gap-5 lg:gap-10 w-[90%] lg:w-[80%] max-w-[1080px] mx-auto px-6 py-6 md:px-8 lg:px-10 lg:py-8 bg-white/15 backdrop-blur-[10px] rounded-[10px] mt-5 -mb-[30px]">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-white font-[var(--font-poppins)] text-base font-bold mb-1">7 Cities Served</h4>
              <p className="text-white/85 text-[13px] leading-relaxed">Full Solano County coverage</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-12 h-12 bg-[#fbeaea] rounded-full flex items-center justify-center">
      ...
      <ErrorBoundary>
        <CityFaqsSection cityName="Solano County" faqs={countyFaqs} />
      </ErrorBoundary>
      ...
      <section className="py-16 bg-[#0d1117]">
        <div className="w-[90%] max-w-[1100px] mx-auto">
          ...
          <h2 className="font-[var(--font-poppins)] text-[26px] md:text-[32px] font-bold text-white text-center mb-3">
            Interactive Map — Solano County
          </h2>
          <p className="font-[var(--font-poppins)] text-white/70 text-center mb-10 max-w-2xl mx-auto">
            Click any marker to learn more about dumpster rental in that city. We deliver to every corner of Solano County.
          </p>
          <CountyMapWrapper />
        </div>
      </section>
        ...
        <div className="w-[90%] max-w-[1000px] mx-auto">
          <div className="bg-[#f8f8f8] rounded-2xl p-8 md:p-12 border border-gray-100">
            ...
            <h2 className="font-[var(--font-poppins)] text-[24px] md:text-[30px] font-bold text-[#1a1a1a] mb-8 text-center">
              Your Trusted Dumpster Rental Partner in Solano County
            </h2>
            <div className="space-y-5 text-[#555] text-[15px] leading-[1.85] font-[var(--font-poppins)]">
              <p>
                Solano County is a vibrant and growing region in the northeastern San Francisco Bay Area, stretching from the waterfront city of Vallejo in the south to the agricultural hub of Dixon in the north. With a population of over 450,000 residents across seven incorporated cities, the county sees constant residential construction, home renovation, agricultural activity, and commercial development — all of which generate waste that needs efficient, reliable removal.
              </p>
              <p>
                TP Dumpsters is proud to serve every city in Solano County with affordable roll-off dumpster rentals. Whether you&apos;re a homeowner in Vacaville remodeling a kitchen, a contractor managing a new development in Fairfield, or a farmer in Dixon clearing old structures, we have the right size dumpster for your project. Our fleet includes 10-yard, 20-yard, and 30-yard containers — designed to handle everything from small garage cleanouts to large-scale construction and agricultural debris.
              </p>
              <p>
                Our service area covers the entire county — from the historic capital city of Benicia on the Carquinez Strait to the wine country gateway of American Canyon, from the waterfront charm of Suisun City to the county seat of Fairfield. Whether you&apos;re in an established neighborhood or a new subdivision, one call to TP Dumpsters covers it all. Our same-day delivery service ensures your project stays on schedule, and our transparent pricing means no surprise fees.
              </p>
              <p>
                We understand that navigating dumpster permits can be confusing, especially when each city in Solano County has its own regulations. That&apos;s why our bilingual team (English and Spanish) is ready to help guide you through the process, answer your questions, and ensure your rental experience is smooth from start to finish. Whether you&apos;re cleaning up after a storm, demolishing a deck, tackling a full home renovation, or clearing agricultural debris, TP Dumpsters delivers reliability, affordability, and outstanding customer service throughout Solano County.
              </p>
            </div>
