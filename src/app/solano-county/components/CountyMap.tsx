...
const SOLANO_CITIES: CityMarker[] = [
  { name: "Vallejo", slug: "vallejo", lat: 38.1041, lng: -122.2566 },
  { name: "Fairfield", slug: "fairfield", lat: 38.2494, lng: -122.0400 },
  { name: "Vacaville", slug: "vacaville", lat: 38.3566, lng: -121.9877 },
